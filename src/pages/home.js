...
import cucumberlogo from '../img/cucumberlogo.png';
import seleniumlogo from '../img/seleniumlogo.png';
    ...
    <div>
        ...
        <div className="bg-gray-600 pr-5 pl-5 lg:pl-32 lg:pr-32">
            ...
            <div className="flex flex-col justify-center pb-10">
                ...
                <div className="flex flex-row justify-center">
                    <div className="text-center text-sm p-5">
                        <a className="pb-1"><img width="100" className="bg-gray-200 rounded" height="100" src={testnglogo}></img></a><br/>
                        <p>TestNG</p>
                    </div>
                    <div className="text-center text-sm p-5">
                        <a className="pb-1"><img width="100" className="bg-gray-200 rounded" height="100" src={seleniumlogo}></img></a><br/>
                        <p>Selenium</p>
                    </div>
                    <div className="text-center text-sm p-5">
                        <a className="pb-1"><img width="100" height="100" className="bg-gray-200 rounded"  src={cucumberlogo}></img></a><br/>
                        <p>Cucumber</p>
                    </div>
                    <div className="text-center text-sm p-5">
